  ...
  <div class="about">
    <section id="machine-learning-fundamentals">
      ...
      <div>
        ...
        <div>
          <h4 class="header bold">Domain set</h4>
          <p>
        ...
        <div>
          <h4 class="header bold">Label set</h4>
        ...
        <div>
          <h4 class="header bold">Training data</h4>
          <p>The sequence of labeled domain points is a finite sequence of pairs in <strong>X × Y</strong>:</p>
        ...
        <div>
          <h4 class="header bold">The learner’s output</h4>
        ...
        <div>
          <h1 class="header bold">Assumptions on ML models</h1>
          <ul>
            <li>We assume an (unknown) underlying distribution of the real world <strong>𝓓</strong></li>
          ...
          <div>
            <h4 class="header">Generalization error</h4>
            ...
            <p>The error <strong><div class="inline-latex"  v-katex="'L_{\\mathcal{D}, f}(h)'">several</div></strong> has several synonymous names such as the generalization error, the risk, or the true error of h.</p>
          </div>

          <div>
            <h3 class="header bold">Empirical risk error</h3>
            ...
            <p>where <div class="inline-latex"  v-katex="'m := |S|'"></div>. The terms empirical error and empirical risk are often used interchangeably for this error.</p>
          </div>
