  ...
  <div>
    <section id="machine-learning-fundamentals">
      ...
      <div>
        ...
        <div>
          <h4>Assumptions on ML models</h4>
          <ul>
          ...
          <div>
            ...
            <pre>L_{𝓓, f}(h) = 𝓟_{x ∼ 𝓓}[h(x) ≠ f(x)] = 𝓓({ x: h(x) ≠ f(x) })</pre>
            <p>The error <strong>L_{𝓓, f}(h)</strong> has several synonymous names such as the generalization error, the risk, or the true error of h.</p>
          </div>

          <div>
            <h5>Empirical risk error</h5>
