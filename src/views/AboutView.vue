      ...
      <div>
        ...
        <div>
          ...
          <div>
            ...
            <p>The error <strong><div v-katex:display="'L_{\\mathcal{D}, f}(h)'">
            </div></strong> has several synonymous names such as the generalization error, the risk, or the true error of h.</p>
          </div>
